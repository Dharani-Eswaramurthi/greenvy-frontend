...
const TermsAndConditions = () => {
    return (
        <Box p={8}>
            ...
            <Text mb={4}>
                For the purpose of these Terms and Conditions, The term "we", "us", "our" used anywhere on this page shall mean Greenvy Team, whose registered/operational office is Peelamedu, Coimbatore, Tamil Nadu, India. "you", “your”, "user", “visitor” shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us. Your use of the website and/or purchase from us are governed by following Terms and Conditions:
            </Text>
            <Text mb={4}>
            ...
            <Text mb={4}>
                From time to time our website may also include links to other websites. These links are provided for your convenience to provide further information. You may not create a link to our website from another website or document without Greenvy Team’s prior written consent.
            </Text>
            <Text mb={4}>
