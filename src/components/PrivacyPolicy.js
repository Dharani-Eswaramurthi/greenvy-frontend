...
const PrivacyPolicy = () => {
    return (
        <Box p={8}>
            ...
            <Text mb={4}>
                This privacy policy sets out how Greenvy Team uses and protects any information that you give Greenvy Team when you visit their website and/or agree to purchase from them. Greenvy Team is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, and then you can be assured that it will only be used in accordance with this privacy statement. Greenvy Team may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you adhere to these changes.
            </Text>
            <Text mb={4}>
